...
<head>
    ...
    <script src="https://ai-public.creatie.ai/gen_page/tailwind-config.min.js" data-color="#6B46C1"
...
<header class="relative bg-white border-b border-gray-200">
    <nav class="mx-auto max-w-8xl px-6 lg:px-8" aria-label="Top">
        <div class="flex w-full items-center justify-between py-6">
            ...
            <div class="hidden lg:flex lg:items-center lg:space-x-6">
                ...
                <a href="/find-groups" class="text-sm font-medium text-purple-600 hover:text-purple-500"><i
                        class="far fa-compass mr-2"></i><span class="font-bold">모임 찾아보기</span></a>
            </div>
        ...
        <div class="lg:hidden absolute top-full left-0 w-full bg-white border-t border-gray-200 py-4 px-6 space-y-4 hidden">
            ...
            <a href="/find-groups" class="block text-base font-medium text-purple-600 hover:text-purple-500"><i
                    class="far fa-compass mr-2"></i><span class="font-bold">모임 찾아보기</span></a>
        </div>
    </nav>
</header>
