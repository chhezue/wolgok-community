            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div class="hidden md:ml-8 md:flex md:space-x-8">
                        <div class="relative">
                            <button class="inline-flex items-center px-1 pt-1 text-gray-700 hover:text-custom">
                                둘러보기
                                <i class="fas fa-chevron-down ml-2 text-sm"></i>
                            </button>
                        </div>
                        <a href="#" class="inline-flex items-center px-1 pt-1 text-gray-700 hover:text-custom">
                            학습 경로
                        </a>
                    <a href="/wolgok-community/member/myclub" class="inline-flex items-center px-1 pt-1 text-gray-700 hover:text-custom">나의 모임</a></div>
                </div>
                <div class="flex-1 flex items-center justify-center px-2 lg:px-0">
                    <div class="max-w-lg w-full">
                        <div class="relative">
                            ...
                            <input type="text" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-custom focus:border-custom sm:text-sm" placeholder="오늘은 무엇을 배우고 싶으신가요?"/>
                        </div>
                    </div>
                </div>
                <div class="flex items-center space-x-6">
                    <a href="#" class="text-gray-700 hover:text-custom">내 수업</a>
        ...
        <div class="grid grid-cols-12 gap-8 items-start">
            <div class="col-span-3">
                <div class="bg-white rounded-lg shadow p-6 space-y-6"><div class="text-center mb-4"><div class="text-xl font-medium text-gray-900">3</div><div class="text-sm text-gray-500">가입한 모임</div></div>
                    ...
                    </div><div class="mt-4 flex justify-center"><button class="w-full px-4 py-2 bg-custom text-white rounded-md text-sm hover:bg-custom/90">나의 모임</button></div>
                </div>
            </div>
            	...
            	<div class="bg-white rounded-lg shadow">
            		...
            		<form class="space-y-6">
            			<div>
            				...
            				<input type="text" id="name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-custom focus:ring-custom sm:text-sm" value="${memberName}"/>
            			</div>
            			<div class="mb-6">
            				<label for="phone" class="block text-sm font-medium text-gray-700">전화번호</label>
            				<input type="tel" id="phone" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-custom focus:ring-custom sm:text-sm" value="${phone}"/>
            			</div>
            			<div class="mb-6">
            			...
            			<div class="mb-6">
            				...
            				<input type="email" id="email" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-custom focus:ring-custom sm:text-sm" value="${email}"/>
            			</div>
            			<div>
            				<label for="bio" class="block text-sm font-medium text-gray-700">소개</label>
            				<textarea id="bio" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-custom focus:ring-custom sm:text-sm">${bio}</textarea>
            			</div>
            			<div>
            				<label for="website" class="block text-sm font-medium text-gray-700">웹사이트</label>
            				<input type="url" id="website" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-custom focus:ring-custom sm:text-sm" value="${website}"/>
            			</div>
            			<div>
            				<label for="profile-photo" class="block text-sm font-medium text-gray-700">프로필 사진</label>
            				<div class="mt-2 flex items-center">
            					<img src="${profileImageUrl}" alt="현재 프로필 사진" class="h-12 w-12 rounded-full"/>
