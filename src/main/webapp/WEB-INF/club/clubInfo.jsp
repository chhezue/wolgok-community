        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="relative h-64">
                ...
                <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-6">
                    <h1 class="text-3xl font-bold text-white">서울 독서 모임</h1>
                    <p class="text-white mt-2">2024년 3월</p>
                </div>
            </div>
            ...
            <div class="p-6">
                <div class="flex gap-2 mb-6"><span
                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-custom/10 text-custom">#독서모임</span><span
                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-custom/10 text-custom">#서울</span>
                </div>
                <div class="prose max-w-none"><h2 class="text-2xl font-bold text-gray-900 mb-4">함께 책을 읽고 이야기 나누는 모임</h2>
                    <p class="text-gray-600 mb-6">매주 토요일 오후, 서울 시내의 조용한 카페에서 모여 함께 책을 읽고 토론하는 모임입니다. 다양한 장르의 책을 선정하여 읽고,
                        서로의 생각을 나누며 새로운 시각을 발견하는 즐거움을 함께 나누고 있습니다. 독서를 좋아하는 20-30대 직장인들과 함께 하는 따뜻한 모임에 여러분을 초대합니다.</p>
                    <div class="mb-8"><h3 class="text-xl font-bold text-gray-900 mb-4">이번 달 일정</h3>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <div class="grid grid-cols-2 gap-4">
                                <div class="bg-white p-4 rounded-lg shadow-sm">
                                    <div class="text-custom font-medium mb-2">정기 모임</div>
                                    <div class="space-y-2">
                                        <div class="flex items-center"><i
                                                class="far fa-calendar-alt mr-2 text-gray-400"></i><span>3월 23일 (토) 14:00</span>
                                        </div>
                                        <div class="flex items-center"><i
                                                class="far fa-calendar-alt mr-2 text-gray-400"></i><span>3월 30일 (토) 14:00</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="bg-white p-4 rounded-lg shadow-sm">
                                    <div class="text-custom font-medium mb-2">번개 모임</div>
                                    <div class="space-y-2">
                                        <div class="flex items-center"><i
                                                class="fas fa-bolt mr-2 text-gray-400"></i><span>3월 20일 (수) 19:00</span>
                                        </div>
                                        <div class="flex items-center"><i
                                                class="fas fa-bolt mr-2 text-gray-400"></i><span>3월 27일 (수) 19:00</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="text-sm text-gray-500 mb-8">
                        <div class="mb-2"><i class="far fa-calendar-alt mr-2"></i>모임 개설일: 2024년 1월 1일</div>
                    </div>
                </div>
                <div class="flex gap-4">
                    ...
                    <button class="!rounded-button bg-gray-100 text-gray-700 py-3 px-4 font-medium hover:bg-gray-200 transition-colors flex items-center justify-center"
                            style="flex: 4;"><i class="fas fa-share-alt mr-2"></i>공유하기
                    </button>
                </div>
            </div>
        </div>
